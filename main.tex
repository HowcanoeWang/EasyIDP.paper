...
The case study used the lotus (\textif{Nelumbo nucifera}) plot in Nishi-Tokyo, Tokyo, Japan. The total 112 different varieties of lotus were sown in squire cultivation ponds on the early May, 2017 (Figure \ref{fig:plotid}). The ordinary local management practices were used to managed all trails.
