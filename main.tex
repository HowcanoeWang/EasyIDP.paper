...
\subsubsection*{Image collection and 3D reconstruction by SfM-MVS}
% image collection
...
It is a python package without any \acrfull*{gui}, all the performance a based on API, please refer to the following link \url{https://www.to.be.continued.org}. Instead of introducing how the package is used, this section demonstrate the algorithm for calculation
...
%
%    3. (raw2raw) current internal external params is highly pre-ground depended , need pmatix to solve non dependent and improve the performance
%
