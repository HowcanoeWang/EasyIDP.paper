...
Applying 3D based high-throughput phenotyping in agriculture provides an advanced and efficient method for managing and monitoring crops. The \acrfull*{sfm}, applicable to commercial available RGB digital cameras, has been widely used to implement this task. However, producing analyzable quality of 3D products, including \acrfull*{dom}, \acrfull*{dsm}, and \acrfull*{pcd}, is computation intensive and time-consuming, and many studies analyze those outputs separately without linking to raw images with abundant first-hand information. Meanwhile, directly applying those outputs to deep learning framework is still difficult due to those outputs file size and \acrfull*{roi} annotation format.
